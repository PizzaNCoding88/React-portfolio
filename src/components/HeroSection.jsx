    ...
    <>
      <div className="h-[calc(100vh-5.25rem)] flex justify-center items-center font-Ubuntu relative">
        ...
        <div className="w-4/5 z-20">
          ...
          <p className="text-right mt-20 text-secondary font-bold text-xl sm:mt-32 md:text-3xl">
            Web Dev
          </p>
        </div>
